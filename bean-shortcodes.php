...
class Bean_BeanShortcodes {
	...
	function action_frontend_scripts() {
		// CSS
		$default_css_url = plugin_dir_url(__FILE__) . 'assets/bean-shortcodes.css';
		$default_js_url = plugin_dir_url(__FILE__) . 'assets/js/bean-shortcodes.js';
		$default_prettify_url = plugin_dir_url(__FILE__) . 'assets/js/prettify.js';
